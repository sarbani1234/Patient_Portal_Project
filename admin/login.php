...
<body topmargin = 0 leftmargin = 0>
	...
	<form action="logincheck.php" method="POST">
      ...
      <img src="banneradmin.png" style="width: 100%;">
      <span style="position: absolute;top: 120px;left: 20px;font-family: monospace;font-size: 40px;color: white;">We Cleaveland Clinic</span><br><br><br><br>
    ...
    <div style="position: absolute;top: 1050px;width: 100%;">
		 <input style="position: absolute;top: 150px;left: 50px;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="text" name="user" value="" placeholder="Username" required="true" autocomplete="off"><br>
		 <input style="position: absolute;top: 250px;left: 50px;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="password" name="pass" required="true"
                                           placeholder="Password" autocomplete="off"><br>
          <button type="submit" name="login" class="offset" style="position: absolute;top: 550px;left: 45%;" type="submit" name="submit" class="offset">login</button>
         <iframe width="660" height="415" style="position: absolute;right: 50px;" src="https://www.youtube.com/embed/XVJEqyv3P6s?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
          <!--footer starts here-->
