...
<head>
    ...
    <title>Doctor: Manage Medicines</title>
...
<td>
<a href="edit_medicine.php?med_id=<?php echo base64_encode($row['Prescription_id'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit">Edit</a>
</td>
</tr>
<?php 
$cnt++;
}} else {
    echo "<script>alert('You have not add medicines!!')</script>"; 
}} ?>
