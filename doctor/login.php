...
if(isset($_POST['login']))
  {
   $emailcon=$_POST['emailcont'];
    ...
    $query=mysqli_query($con,"select ID from tbldocapprove where (Email='$emailcon' || Mobilenumber='$emailcon') && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['meddbdid']=$ret['ID'];
...
<body topmargin = 0 leftmargin = 0>
  <div class="covidalert">
    ...
    <div style="position: absolute;top: 350px;width: 100%;">
      ...
      <span style="position: absolute;top: 120px;left: 20px;font-family: monospace;font-size: 40px;color: white;">Our Life Saviour</span><br><br><br><br>
  ...
  <button type="submit" name="login" class="offset" style="position: absolute;top: 550px;left: 45%;">Log In</button><br>
  <iframe width="660" height="415" style="position: absolute;right: 50px;" src="https://www.youtube.com/embed/mg0j1QZ597g?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <a href="forgot-password.php" style="position: absolute;top: 400px;left: 50px;text-decoration: none;font-family: cursive;font-size: 30px;color: #333;"> Have you forgot your password ?</a>
                        <p><a href="doctor_register.php" style="position: absolute;top: 450px;left: 50px;font-family: cursive;color: #333;font-size: 30px;text-decoration: none;">Create Account</a></p>
                      </div>
                      <!--footer starts here-->
